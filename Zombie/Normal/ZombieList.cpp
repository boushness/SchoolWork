...
// Processes request to kill a Zombie.
 void ZombieList::kill(string zombieName)
{
    ...
    else if(inZombieRing(zombieName))
    {
        ...
        {
            killer->setNext(curr->getNext());
        }

        cout << killer->getName() << " killed "
            << curr->getName() << endl << endl;
