...
USE master
DROP DATABASE Ruckman_Riley_backend
GO

CREATE DATABASE Ruckman_Riley_backend
GO

USE Ruckman_Riley_backend
GO
---------------------------------------------------------------------------------------------------
-- Run each function individually after creating and using TCSS445_Project database

CREATE FUNCTION dbo.IsCompanyCheck ( @field int )
RETURNS int AS
BEGIN
	return (SELECT isCompany FROM CUSTOMER WHERE CustomerID = @field)
END
GO

CREATE FUNCTION dbo.ProfileTypeCheck ( @field VARCHAR(5) )
RETURNS CHAR(1) AS
BEGIN
	return (SELECT ProfileType FROM DOORPROFILE WHERE ProfileName = @field)
END
GO
...
(
	CustomerID int NOT NULL references CUSTOMER(CustomerID) PRIMARY KEY,
	...
	CONSTRAINT CheckCustomerCompany
		CHECK (dbo.IsCompanyCheck(CustomerID) = 1), 
...
CREATE TABLE JOB
(
	JobNumber int IDENTITY(1,1) PRIMARY KEY,
...
(
	...
	JobNumber int NOT NULL references Job(JobNumber) UNIQUE,
...
(
	QuoteNumber int IDENTITY(1,1) PRIMARY KEY,
	JobNumber int NOT NULL references Job(JobNumber) UNIQUE,
...
(
	InsideProfileName VARCHAR(5) NOT NULL references DOORPROFILE(ProfileName) PRIMARY KEY,
...
--Addresses:
INSERT INTO ADDRESSES VALUES('1231 65Th Ave W', 'Tacoma', 'WA', '98468')
INSERT INTO ADDRESSES VALUES('92 34Th Ave Ct E', 'Honolulu', 'HI', '96701')

--1 - Tom's Cabinets
--2 - Rick's Woodworking

--Contact:
INSERT INTO CONTACT VALUES ('Tom', 'Hardey', '253-897-2013', 'tomh@timscab.com')
INSERT INTO CONTACT VALUES ('Charles', 'Hardey', '253-658-1852', 'rickh@timscab.com')
INSERT INTO CONTACT VALUES ('Rick', 'Thin', '808-322-2853', 'rickthin@gmail.com')
INSERT INTO CONTACT VALUES ('Thomas', 'Picle', '253-242-1513', 'thopic12@yahoo.com')
...
--Customer:
INSERT INTO CUSTOMER VALUES('Tom''s Cabinets', 1, 1, '253-653-1249', NULL, 'office@timscab.com', 1, 0.0, 'OUR TRUCK', 0.0, 1)
INSERT INTO CUSTOMER VALUES('Rick''s Woodworking', 2, 2, '808-322-2634', NULL, 'rickthin@gmail.com', 3, 0.0, 'CRATE', 0.0, 1)
...
--JobOrder:
INSERT INTO JOBORDER VALUES(1, 'Perfect Sizing', 'Call Customer for Payment', NULL, NULL, 'In Production')
INSERT INTO JOBORDER VALUES(2, NULL, 'Call Customer for Payment', NULL, NULL, 'Processing')
INSERT INTO JOBORDER VALUES(3, NULL, NULL, 'Package Carefully!', NULL, 'Completed')
INSERT INTO JOBORDER VALUES(5, 'Rustic Maple', 'A check will be mailed in.', NULL, 'WILL CALL', 'In Production')
INSERT INTO JOBORDER VALUES(6, 'Perfect Sizing', 'Call Customer for Payment', NULL, NULL, 'Completed')
INSERT INTO JOBORDER VALUES(7, NULL, 'Call Customer for Payment', NULL, NULL, 'Completed')

--JobQuote:
INSERT INTO JOBQUOTE VALUES(4, NULL)
