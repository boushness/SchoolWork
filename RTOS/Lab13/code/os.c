...
uint32_t event1Period;				// pointer to period of first periodic user function
void (*PeriodicEvent2)(void); 	// pointer to second periodic user function
uint32_t event2Period;				// pointer to period of second periodic user function
